...
(library Library_1
	...
	(compDef "FSUSB42MUX" (originalName "FSUSB42MUX") (compHeader (numPins 10) (numParts 1) (refDesPrefix U)
		...
		(compPin "2" (pinName "SEL") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "10" (pinName "/OE") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "HSD2+") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "HSD2-") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "HSD1+") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "HSD1-") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.onsemi.com/pub/Collateral/FSUSB42-D.PDF")
		(attr "Height" "1.1 mm")
	)
