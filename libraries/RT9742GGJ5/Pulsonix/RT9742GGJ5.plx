...
(library Library_1
	...
	(compDef "RT9742GGJ5" (originalName "RT9742GGJ5") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "__FLG") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/RT9742GGJ5.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "RT9742GGJ5.stp")
